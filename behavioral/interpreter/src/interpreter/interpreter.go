...
// Interpreter patterns are languages to perform common
// types of operations

// This pattern does the following:
// Provides syntax for very common operations in some
// scope
// Has an intermediate language to translate actions
// between two systems
// Eases the use of some operations in an easier-to-use
// form of syntax
